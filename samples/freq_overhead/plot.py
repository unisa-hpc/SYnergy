...
df['app_energy2'] = data2['app_kernel_energy_Average'] #- data1['app_kernel_energy_Average']
df['app_energy_err2'] = data2['app_kernel_energy_Stdev']
df['phase_energy2'] = data2['phase_kernel_energy_Average'] #- data1['phase_kernel_energy_Average']
df['phase_energy_err2'] = data2['phase_kernel_energy_Stdev']
df['kernel_energy2'] = data2['kernel_kernel_energy_Average'] #- data1['kernel_kernel_energy_Average']
df['kernel_energy_err2'] = data2['kernel_kernel_energy_Stdev']
