...
#if defined(SYNERGY_LZ_SUPPORT) || defined(SYNERGY_CUDA_SUPPORT) || defined(SYNERGY_GEOPM_SUPPORT)
...
#if defined(SYNERGY_LZ_SUPPORT) || defined(SYNERGY_CUDA_SUPPORT) || defined(SYNERGY_GEOPM_SUPPORT) // TODO: doesn't work with GEOPM
